...
export default function Profile({ author, social, features, researchInterests }: ProfileProps) {
    ...
    return (
        ...
        >
            {/* Profile Image */}
            <div className="w-64 h-64 mx-auto mb-6 rounded-full overflow-hidden shadow-lg border-4 border-primary/20 hover:shadow-xl transition-all duration-200 hover:scale-105">
                <Image
                    src={author.avatar}
                    alt={author.name}
                    width={256}
